#!/usr/bin/env python3
"""Test Hierarchical CE-SVM on Solar Flare dataset with Single Filter strategy."""
...
def main():
    ...
    data_file = Path.home() / "Developer/NSVORA/datasets/primary/solar_flare/solar_flare_split.xlsx"
    ...
    print("=" * 60)
    print("Hierarchical CE-SVM on Solar Flare Dataset")
    print("Strategy: Single Filter (Minority Class First)")
    print("=" * 60)
    print(f"\nLoading data from: {data_file}")
    print("\nDataset Info:")
    print("  - Extremely imbalanced (22.3:1 ratio)")
    print("  - Class 1 (No flare): 691 samples (81.1%)")
    print("  - Class 2 (C-class): 130 samples (15.3%)")
    print("  - Class 3 (Severe M/X): 31 samples (3.6%) - MINORITY")
    print("  - Features: 10")
    print("  - Total samples: 852")
    print()
    ...
    print("  H1: Class 3 (minority) vs {1,2} - Separate severe flares first")
    print("  H2: Class 2 vs Class 1 - Then separate C-class from background")
    print()
